...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/odev2_22bahar/odev2_22bahar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vuruslu_islemci.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vuruslu_islemci.tcl
