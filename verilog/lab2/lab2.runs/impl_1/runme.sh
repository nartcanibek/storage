...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log f_lab2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source f_lab2.tcl -notrace
