...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log f_lab2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source f_lab2.tcl
