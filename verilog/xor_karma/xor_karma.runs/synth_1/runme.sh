...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/xor_karma/xor_karma.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log isim_sifrele.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source isim_sifrele.tcl
