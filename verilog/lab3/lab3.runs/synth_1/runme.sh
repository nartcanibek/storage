...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log f_lab3_a.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source f_lab3_a.tcl
