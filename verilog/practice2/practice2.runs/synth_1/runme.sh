...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/practice2/practice2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log virgullu_bolme.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source virgullu_bolme.tcl
