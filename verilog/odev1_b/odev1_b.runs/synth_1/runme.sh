...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/odev1_b/odev1_b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log odev1_b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source odev1_b.tcl
