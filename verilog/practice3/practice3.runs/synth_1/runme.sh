...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/practice3/practice3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log siparis_denetimi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source siparis_denetimi.tcl
