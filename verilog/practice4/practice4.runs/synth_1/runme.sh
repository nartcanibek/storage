...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/practice4/practice4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dikdortgen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dikdortgen.tcl
