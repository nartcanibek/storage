...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/arasinav/arasinav.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kodla_coz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kodla_coz.tcl
