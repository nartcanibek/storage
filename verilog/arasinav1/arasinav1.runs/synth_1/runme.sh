...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/arasinav1/arasinav1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log masa_denetimi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source masa_denetimi.tcl
