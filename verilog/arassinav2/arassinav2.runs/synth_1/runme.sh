...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/arassinav2/arassinav2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log paketleyici.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source paketleyici.tcl
