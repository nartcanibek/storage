...
module aes_engine(
  ...
  assign hazir = 1'b1;  // düzenlenecek
  ...
  assign c_gecerli = g_gecerli;
    ...
    wire [127:0] keyout1,keyout2,keyout3,keyout4,keyout5,keyout6,keyout7,keyout8,keyout9;
	 ...
	 assign r0_out = blok^anahtar;
	 
    rounds r1(.clk(clk),.rc(4'b0000),.data(r0_out),.keyin(anahtar),.keyout(keyout1),.rndout(r1_out));
    ...
    rounndlast r10(.clk(clk),.rc(4'b1001),.rin(r9_out),.keylastin(keyout9),.fout(sifre),.c_gecerli(c_gecerli));
