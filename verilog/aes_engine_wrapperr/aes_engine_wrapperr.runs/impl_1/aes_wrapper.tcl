...
set rc [catch {
  ...
  add_files -quiet C:/Users/AliAzak/Desktop/aes_engine_wrapper/aes_engine_wrapper.runs/synth_1/aes_wrapper.dcp
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file aes_wrapper_timing_summary_routed.rpt -pb aes_wrapper_timing_summary_routed.pb -rpx aes_wrapper_timing_summary_routed.rpx -warn_on_violation "
