...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/dort_bit_toplayici/dort_bit_toplayici.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dort_bit_carpici.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dort_bit_carpici.tcl
