...
HD_PWD='C:/Users/nartc/Desktop/verilog kodlar/odev2_a/odev2_a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log odev2_a.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source odev2_a.tcl
